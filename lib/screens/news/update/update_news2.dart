                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(3), color: ColorPicker.kGreenNeon),
                                      child: Center(
                                        child: Text(
                                          'Sign Up Free',
                                    ...
                                    Image.asset('assets/icons/play_whole.png', height: Get.width * 0.02),
                                    SizedBox(
                                      width: 10,
                                    ),
                                    Text(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text('Join the leading community for hospitality. Sign-up free today, we’ll curate your career.', textAlign: TextAlign.start, style: FontTextStyle.kBlueDark24W600PR),
                        ),
                        SizedBox(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Image.asset('assets/icons/play_whole.png', height: Get.width * 0.08),
                              SizedBox(
                                width: 10,
                              ),
                              Text(

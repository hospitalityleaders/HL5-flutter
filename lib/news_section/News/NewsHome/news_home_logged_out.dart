...
class NewsHomeLoggedOut extends StatefulWidget {
  const NewsHomeLoggedOut({Key? key}) : super(key: key);

  @override
  _NewsHomeLoggedOutState createState() => _NewsHomeLoggedOutState();
}

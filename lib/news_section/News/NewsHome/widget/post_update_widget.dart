              ...
              Column(
                ...
                children: [
                  CommonWidget.text(
                    'Hello Noberto',
                    style:
                        FontTextStyle.kPrimary32W600PR.copyWith(fontSize: 20),
                  ),
                  SB.SH15(),
                  SizedBox(
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(5),
                      border: Border.all(color: ColorPicker.kBorder, width: 1),
                  ...
                  child: TextField(
                    decoration: InputDecoration(
                        ...
                        contentPadding:
                            EdgeInsets.only(top: 13, left: 10, bottom: 10),
              ...
              Container(
                ...
                child: Center(
                  child: CommonWidget.text('Post Update',
                      style:
                          FontTextStyle.kWhite18W600PR.copyWith(fontSize: 12)),
                ),
              )
            ],
          )

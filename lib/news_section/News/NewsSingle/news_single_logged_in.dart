...
class _NewsSingleLoggedInScreenState extends State<NewsSingleLoggedInScreen> {
  ...
  Widget build(BuildContext context) {
    // CarouselController buttonCarou
    // selController = CarouselController();
  ...
  Scaffold mobileVew(BuildContext context) {
    return Scaffold(
      ...
      //                       Navigator.pushNamed(
      //                           context, '/${drawerItem[index]}');
      //                       _menuController.setIndex(index);
      //                       _menuController.setString('Home');
      //                     },
      //                     child: Padding(
      ...
      body: SingleChildScrollView(
          ...
          //   child: GetBuilder<GetNewsDataViewModel>(
          //     builder: (controller) {
          //       if (controller.apiResponse.status == Status.COMPLETE) {
          //         GetNewsDataResponseModel _resNewsData =
          ...
          //                                           ),
          //                                           CommonWidget.text(
          //                                             ': ${_resNewsData.data!.user!.fullName}',
          //                                             style: TextStyle(
          //                                                 color: ColorPicker
          //                                                     .kGreyLight5,
          //                                                 fontSize: 17,
          ...
          //                                       ),
          //                                       CommonWidget.text(
          //                                         "${Jiffy(_resNewsData.data!.created).format('do MMMM yyyy • h:mm')}",
          //                                         style: TextStyle(
          //                                           fontSize: 17,
          //                                           color:
  ...
  Material desktopView() {
    return Material(
      child: SingleChildScrollView(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Header(page: 'Newssingleloggedinscreen'),
            Container(
            ...
            // GetBuilder<GetNewsDataViewModel>(
            //   builder: (controller) {
            //     if (controller.apiResponse.status == Status.COMPLETE) {
            //       GetNewsDataResponseModel _resNewsData =
            //           controller.apiResponse.data;
            ...
            //                             '"',
            //                             style:
            //                                 FontTextStyle.kBlueLight150BOLDPR,
            //                           ),
            //                         ),
            //                         Flexible(
            //                           child: CommonWidget.text(

...
class TextContentWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      // height: 100,
      width: ResponsiveValue<double>(context, defaultValue: 150, valueWhen: [Condition.smallerThan(name: TABLET, value: double.infinity)]).value,
      child: Column(
        ...
        children: [
          CommonWidget.text(
            ...
            style: FontTextStyle.kRed18W600PR.copyWith(
                fontSize: ResponsiveValue<double>(context, defaultValue: 14, valueWhen: [Condition.smallerThan(name: TABLET, value: 18)]).value),
          ),
          CommonWidget.text(
          ...
          CommonWidget.text(
            ...
            style: FontTextStyle.kGreyLight10W600PR.copyWith(
                height: 1.5,
                fontSize: ResponsiveValue<double>(context, defaultValue: 10, valueWhen: [Condition.smallerThan(name: TABLET, value: 14)]).value),
          ),
        ],
      ),
    );

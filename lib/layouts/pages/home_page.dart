...
// import 'package:holedo/news_section/News/NewsSingle/news_single_logged_in.dart';
...
//   final my_controller1 = Get.put(Controller());
//
...
//     if (newsCategoryViewModel.circularBool) {
//       setState(() {
//         print("comes to bottom $circularBool");
//         circularBool = true;
//
//         if (circularBool) {
...
//
//           newsCategoryViewModel.newsCategoryPageRefresh(pageCount.toString());
//
//           newsCategoryViewModel.setCircularBool();
//         }
//       });
//     }
//   }
...
//                   Container(
//                     child: FutureBuilder(
//                       future: Get.put(HoledoDatabase().news).fetchArticles1(
...
//                       future: Get.put(HoledoDatabase().news).fetchArticles1(
//                           context: context,
//                           limit: my_controller1.limit.value,
//                           page: my_controller1.page.value),
//                       builder:
//                           (context, AsyncSnapshot<List<Article>> snapshot) {
//                         if (!snapshot.hasData) {
//                           return Center(
...
//                         future: Get.put(HoledoDatabase().news).fetchArticles1(
//                             context: context,
//                             limit: my_controller1.limit.value + 10,
//                             page: my_controller1.page.value + 1),
//                         builder:
//                             (context, AsyncSnapshot<List<Article>> snapshot) {
//                           if (!snapshot.hasData) {
//                             return Center(
